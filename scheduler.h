...
class scheduler {
	public:
		scheduler(bool _preemptive, bool _bestEffort, std::vector<processor>& _processors, std::vector<job>& jobs, int _unfeasibleJobsNumber, int _totalJobsNumber); //construct
	private:
